...
(function ($) {
    ...
    function numberRoller(slno) {
        ...
        var numdiff = max - min;
        var timeout = timediff * 1000 / numdiff + 100;
        //if(numinc<10){
...
!function webpackUniversalModuleDefinition(root, factory) {
    ...
    return modules = [function (module) {
        ...
        if (4 & mode && "object" == (typeof value === "undefined" ? "undefined" : _typeof2(value)) && value && value.__esModule) return value;
...
var videos = ['TZipNpBCmzI', 'Eg5_YRGHifE', 'xktgy0Xwx5Q', 'EjckXiTZUPY', 'iIV-ofqGFaY'];
